...
aiopsRouter.get("/anomalies/alerts", authenticate, (req, res) => {
    const severityFilter = typeof req.query.severity === "string" ? req.query.severity.toLowerCase() : "all";
...
aiopsRouter.get("/anomalies/alerts/stats", authenticate, (req, res) => {
