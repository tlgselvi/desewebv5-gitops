 ...
 */
app.post("/dese/query", authenticate, asyncHandler(async (req, res) => {
 ...
 * Requires authentication
 */
app.get("/dese/context", authenticate, asyncHandler(async (req, res) => {
...
initializeMCPWebSocket("dese", httpServer, PORT);
// Start server
