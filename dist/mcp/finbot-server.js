 ...
 */
app.post("/finbot/query", authenticate, asyncHandler(async (req, res) => {
 ...
 * Requires authentication
 */
app.get("/finbot/context", authenticate, asyncHandler(async (req, res) => {
 ...
 * Requires authentication
 */
app.post("/finbot/correlation/run", authenticate, asyncHandler(async (req, res) => {
...
export default app;
//# sourceMappingURL=finbot-server.js.map