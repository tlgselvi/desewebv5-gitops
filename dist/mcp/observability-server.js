 ...
 */
app.post("/observability/query", authenticate, asyncHandler(async (req, res) => {
 ...
 * Requires authentication
 */
app.get("/observability/context", authenticate, asyncHandler(async (req, res) => {
 ...
 * Requires authentication
 */
app.get("/observability/metrics", authenticate, asyncHandler(async (req, res) => {
 ...
 * Requires authentication
 */
app.post("/observability/aggregate", authenticate, asyncHandler(async (req, res) => {
...
export default app;
//# sourceMappingURL=observability-server.js.map