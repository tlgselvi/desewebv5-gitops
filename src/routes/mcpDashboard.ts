...
import {
  mcpDashboardService,
  type ModuleName,
} from "@/services/mcp/mcpDashboardService.js";
import { logger } from "@/utils/logger.js";

const router: Router = Router();

const MODULE_NAMES = ["mubot", "finbot", "aiops", "observability"] as const;
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const moduleName = parseResult.data.moduleName as ModuleName;
