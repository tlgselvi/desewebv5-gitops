...
- **Port:** 5558 (assumed)
- **Health:** `http://localhost:5558/health`
...
### Scripts
- `scripts/jarvis-efficiency-chain.ps1` - Main efficiency chain
- `scripts/jarvis-diagnostic-phase1.ps1` - Phase 1 diagnostics
- `scripts/jarvis-diagnostic-phase2.ps1` - Phase 2 diagnostics
- `scripts/jarvis-diagnostic-phase3.ps1` - Phase 3 diagnostics
...
- `DOCKER_SISTEM_OZET.md` - Docker system summary
- `WSL_OPTIMIZATION_REPORT.md` - WSL optimization report

### Reports
- `reports/jarvis_diagnostic_summary.md` - JARVIS diagnostics
- `reports/efficiency_report_*.md` - Efficiency reports
