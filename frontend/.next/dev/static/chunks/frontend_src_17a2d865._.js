            ...
            const fetchData = {
                "Dashboard.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        try {
                            projectsData = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiMethods"].get("/projects?status=active");
                        } catch (projectsError) {
                            const errorMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getErrorMessage"])(projectsError);
                            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].warn("Failed to fetch projects", {
                                error: errorMessage,
                                status: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isAxiosError"])(projectsError) ? projectsError.response?.status : undefined
                            });
                        ...
                        try {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].debug("Health check failed (non-critical)", {
                        ...
                        setStats({
                            ...
                            activeProjects: projectsData.projects?.filter({
                                "Dashboard.useEffect.fetchData": (p)=>p.status === 'active'
                            }["Dashboard.useEffect.fetchData"]).length || 0,
                            totalAnalyses: 0,
                            avgDomainAuthority: projectsData.projects?.length > 0 ? Math.round(projectsData.projects.reduce({
                                "Dashboard.useEffect.fetchData": (sum, p)=>sum + (p.targetDomainAuthority || 0)
                            }["Dashboard.useEffect.fetchData"], 0) / projectsData.projects.length) : 0
                        });
                    } catch (error) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error("Error fetching dashboard data", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: projects.map((project)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(Dashboard, "CnV7WO10uuY+qa7OCfBt5fLGQdE=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=frontend_src_17a2d865._.js.map